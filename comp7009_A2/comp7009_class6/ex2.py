...
password = input("Enter emoji password for registration: ")
register(username, password)

login_password = input("Enter the same emoji password to log in: ")
login(username, login_password)

wrong_password = input("Enter a different emoji password to test rejection: ")
